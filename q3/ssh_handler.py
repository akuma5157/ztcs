...
# totally ripped off of example at https://docs.ansible.com/ansible/latest/dev_guide/developing_api.html
...
def execute(hosts_file="hosts", command=None):
    ...
    play_source = dict(
        ...
        hosts="all",
        gather_facts="no",
        tasks=[dict(action=dict(module="shell", args=dict(cmd=command))),],
    )
